...
path = paste0("data/station_locations.Rdata")
station_locations <- readRDS(path)

## saving and exporting datasets
save(station_locations, file = "data/station_locations.rda")
# checking file info
file.info("data/station_locations.rda")
file.size("data/station_locations.rda")
# check rda to verify the best compression
tools::checkRdaFiles("data/station_locations.rda")
# resave rda with a better compression if available
tools::resaveRdaFiles("data/station_locations.rda")
tools::checkRdaFiles("data/station_locations.rda")
